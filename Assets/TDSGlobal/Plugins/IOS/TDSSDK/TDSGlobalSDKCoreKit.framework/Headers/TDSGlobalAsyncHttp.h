...
extern NSString *const TDS_GLOBAL_TIMEOUTKEY;
extern NSString *const TDS_GLOABL_HTTPMETHODKEY;
extern NSString *const TDS_GLOBAL_HTTPBODYKEY;
extern NSString *const TDS_GLOBAL_DATAFORMAT;

/**
 header
 */
extern NSString *const TDS_GLOBAL_AUTH_KEY;
